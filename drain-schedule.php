...
<head>
    ...
    <title>AquaSmart - Atur Pembuangan Air</title>
...
<body>
    ...
    <main class="app-container">
        ...
        <section class="schedule-page-header">
            <h2>Pembuangan Air</h2>
            <p>Atur jadwal pembuangan air otomatis</p>
        </section>

        <!-- Current Settings Display -->
        <section class="current-settings">
            <div class="setting-card">
                <span class="setting-label">Durasi Pembuangan Terakhir</span>
                <span class="setting-value">5 Menit</span>
            </div>
        </section>

        <!-- Schedule Form -->
        <section class="water-schedule-form">
            <h3 class="form-title">Durasi Pembuangan Air</h3>
            
            <!-- Duration Presets -->
            <div class="duration-section">
                <label class="section-label">Pilih Durasi</label>
                <div class="duration-presets">
                    <button class="duration-btn" data-duration="3">
                        <span class="duration-label">Ringan</span>
                    ...
                    <button class="duration-btn" data-duration="10">
                        <span class="duration-label">Banyak</span>
            ...
            <!-- Info Box -->
            <div class="info-box">
                <p>📌 <strong>Catatan:</strong> Air akan dibuang sesuai dengan durasi yang dipilih. Pompa akan berhenti otomatis setelah selesai.</p>
            </div>
